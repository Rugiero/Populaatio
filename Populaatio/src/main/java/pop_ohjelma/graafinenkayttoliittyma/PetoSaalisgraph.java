 ...
 * @author iangervu
 */
public class PetoSaalisgraph implements Runnable, ActionListener {
    ...
    private void luoKomponentit(Container container) {
        ...
        JLabel F0 = new JLabel("F ");
        F0kentta = new JTextField();
        JLabel R0 = new JLabel("R  ");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == Nappi) {
            ...
            if ((DesimaalinSyotto(akentta.getText()) && DesimaalinSyotto(bkentta.getText()) && DesimaalinSyotto(ckentta.getText()) && DesimaalinSyotto(dkentta.getText())) == false) {
                infokentta.setText("Tarkista syöte!");
            } else {
