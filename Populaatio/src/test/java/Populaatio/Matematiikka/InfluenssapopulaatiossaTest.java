...
//Haluamme pituutta 2 olevan arraylistin
    ...
    public void KokeillaanLaskeaEriArvoillaSIS() {
        ...
        assertEquals(2, new Matematiikka.Influenssapopulaatiossa().laskeSIS(50, 5, 0.007, 0.1,200).size());
        assertEquals(2, new Matematiikka.Influenssapopulaatiossa().laskeSIS(1, 0, 0.01, 0.01, 0).size());
        assertEquals(2, new Matematiikka.Influenssapopulaatiossa().laskeSIS(1, 0, 0.99, 0.99,400).size());
        assertEquals(2, new Matematiikka.Influenssapopulaatiossa().laskeSIS(5000, 4999, 0.5, 0.5,2).size());
